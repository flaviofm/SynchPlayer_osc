...
(function (global, factory) {
  ...
  function stripComments(string) {
    var stripped = '';
    var index = 0;
    var endBlockComment = string.indexOf('*/');
    ...
    while (index < string.length) {
      if (string[index] === '/' && string[index + 1] === '/') {
        ...
        // block comment
        var _endIndex = string.indexOf('*/', index);
  ...
  function parseParams(func) {
    var src = stripComments(func.toString());
  ...
  var parallel = awaitify(function (eachfn, tasks, callback) {
  ...
  function priorityQueue(worker, concurrency) {
    ...
    var push = q.push,
        pushAsync = q.pushAsync;
    q._tasks = new Heap();

    q._createTaskItem = function (_ref2, callback) {
      var data = _ref2.data,
